...
// get cat id
	...
	if ( get_theme_mod( 'bauhaus_map_google_key' ) != '' ) {
		...
		wp_enqueue_script( 'maps-google', 'https://maps.google.com/maps/api/js?key=' . get_theme_mod( 'bauhaus_map_google_key' ), array( 'jquery' ), '1', true );

	} else {
		wp_enqueue_script( 'maps-google', 'https://maps.google.com/maps/api/js', array( 'jquery' ), '1', true );
