...
function bauhaus_my_theme_register_required_plugins2() {
	...
	$source = 'http://plugins.paul-themes.com/plugins/'; 
	...
	$plugins = array(
		...
		array(
			...
			'slug' => 'bauhaus_plugin',
			'required' => true,
			'source' => esc_url( $source . 'bauhaus_plugin.zip' ),
		),
		array(
			'name' => esc_html__( 'WPBakery Page Builder', 'bauhaus' ),
			'slug' => 'js_composer',
			'required' => true,
			'source' => esc_url( $source . 'js_composer.zip' ),
		),
		array(
			'name' => esc_html__( 'Revolution Slider', 'bauhaus' ),
			'slug' => 'revslider',
			'required' => true,
		...
		array(
			'name' => esc_html__( 'GTranslate', 'bauhaus' ),
			'slug' => 'gtranslate',
			'required' => false,
		),
		array(
		...
		array(
			'name' => esc_html__( 'OptionTree', 'jonny' ),
			'slug' => 'option-tree',
			'required' => true,
		),
	);
